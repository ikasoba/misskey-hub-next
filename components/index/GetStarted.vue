<template>
	<div>
		<h2 class="mb-12 text-2xl lg:text-3xl text-center font-bold font-title">
		...
		<div class="grid gap-12 lg:grid-cols-3">
			<div v-fade-in class="find">
				<div class="item">
					...
					<GNuxtLink class="link" :to="localePath('/servers/')">{{
						$t('_landing._getStarted._find.list')
					}}</GNuxtLink>
				</div>
			</div>
			<div v-fade-in class="create">
				<div class="item">
					...
					<GNuxtLink
						class="link"
						:to="localePath('/docs/for-admin/install/guides/')"
						>{{ $t('_landing._getStarted._create.guide') }}</GNuxtLink
					>
				</div>
			</div>
			<div v-fade-in class="docs">
				<div class="item">
					<div class="icon">
						<img src="/img/emojis/light-bulb_1f4a1.png" aria-hidden="true" />
					</div>
					<h3 class="title">{{ $t('_landing._getStarted._docs.title') }}</h3>
					<div class="description"></div>
					<GNuxtLink class="link" :to="localePath('/docs/')">{{
						$t('_landing._getStarted._docs.docs')
					}}</GNuxtLink>
				</div>
			</div>
		</div>
