<template>
	<div
		class="root bg-red-100 dark:bg-red-900 dark:bg-opacity-25 border border-red-200 dark:border-red-500 rounded-lg px-4 py-3 mb-4"
	>
...
const realLabel = computed(() =>
	props.label ? props.label : t('_content.danger'),
);
</script>
