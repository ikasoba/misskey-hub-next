<template>
	<div>
				...
				<div class="hidden lg:block relative px-6 py-8">
					...
					<div class="relative lg:w-64">
						<img
							...
							src="/img/emojis/artist_palette_3d.png"
						/>
					</div>
				</div>
			</template>
		...
		<div class="pb-12 lg:mt-12 pt-6 bg-white dark:bg-slate-950">
			<div
				class="container mx-auto max-w-screen-lg px-6 space-y-6 lg:space-y-8"
			>
				<GLocalNav
					:items="[
						{
				...
				<div id="logo">
					...
					<BrandAssetsImgPreview
						src="https://assets.misskey-hub.net/public/misskey.svg"
					/>
				</div>
				<div id="icon">
					<h2 class="text-2xl lg:text-3xl font-title font-bold mb-4">
				...
				<div id="banner">
					<h2 class="text-2xl lg:text-3xl font-title font-bold mb-4">
						{{ $t(`_brandAssets.banner`) }}
					</h2>
					<a
						class="mb-4 block mx-auto"
						href="https://assets.misskey-hub.net/public/banner.png"
						target="_blank"
					>
						<img
							class="border border-slate-200 dark:border-slate-700"
							src="https://assets.misskey-hub.net/public/banner.png"
						/>
					</a>
					<a
						class="block mx-auto"
						href="https://assets.misskey-hub.net/public/banner-2.png"
						target="_blank"
					>
						<img
							class="border border-slate-200 dark:border-slate-700"
							src="https://assets.misskey-hub.net/public/banner-2.png"
						/>
					</a>
				</div>
